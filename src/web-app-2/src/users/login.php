				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form method="POST" class="needs-validation" id="identicalForm" action="login_script.php" enctype="multipart/form-data" novalidate="" autocomplete="off">
						   ...
						   <p>If you have no account?<a href="signup.php">Register here!</a></p>
						</div>
					</div>
